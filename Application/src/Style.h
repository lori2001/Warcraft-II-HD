...
#define COLOR_BYTE static constexpr const unsigned
	...
	// green
	COLOR_BYTE IN_GAME_SELECT_R = 0;
	COLOR_BYTE IN_GAME_SELECT_G = 255;
	COLOR_BYTE IN_GAME_SELECT_B = 0;

	// red
	COLOR_BYTE SECONDARY_SELECT_COLOR_R = 255;
	COLOR_BYTE SECONDARY_SELECT_COLOR_G = 0;
	COLOR_BYTE SECONDARY_SELECT_COLOR_B = 0;
...
#define FLOAT static constexpr const float
	...
	FLOAT IN_GAME_OUTLINE_THICKNESS = 2.5F;
#undef FLOAT
}
