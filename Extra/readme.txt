These libraries may be outdated.You may go to their website to get the latest.
This folder contains sources which were used in order to make the game.
...
SFML 2.5.0 SETUP:
Beginner: Extract Libraries/SFML-2.5.0-windows-vc15-32-bit.zip to "C:/" directory (create new folder if necessary)
